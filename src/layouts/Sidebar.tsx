...
export function Sidebar() {
  ...
  return (
    <aside className="flex w-60 shrink-0 flex-col border-r border-base-800 bg-base-900">
      <div className="px-5 py-6">
        <span className="font-display text-xl font-bold tracking-tight text-white">Batlay</span>
      </div>
          ...
          <NavLink
            ...
            className={({ isActive }) =>
              `flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-medium transition ${
                isActive ? "bg-base-800 text-white" : "text-muted hover:bg-base-800/60 hover:text-white"
              }`
            }
          >
      ...
      <div className="space-y-2.5 border-t border-base-800 px-4 py-4 text-xs text-muted">
