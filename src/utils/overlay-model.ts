...
/**
 * Tailles de canvas courantes, partagées entre l'éditeur (Taille du canvas) et
 * la fenêtre de création : une seule liste, pour que les deux proposent
 * toujours les mêmes formats.
 */
