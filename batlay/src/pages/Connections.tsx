...
export function Connections() {
  ...
  return (
    <div className="mx-auto max-w-3xl px-8 py-10">
      <h1 className="font-display text-2xl font-semibold text-fg">Connections</h1>
      <p className="mt-1 text-sm text-muted">Choisissez la source musicale de vos overlays.</p>

      {error && (
        <div className="mt-4 rounded-lg border border-red-500/30 bg-red-500/10 px-4 py-2.5 text-sm text-danger-soft">
          {error}
        </div>
      )}
      ...
      <section className="mt-6 rounded-xl2 border border-line bg-base-900 p-6">
        <div className="flex items-center justify-between">
          <div>
            <h2 className="font-medium text-fg">Spotify</h2>
        ...
        {!spotifyConfigured && (
          <div className="mt-4 space-y-2 border-t border-line pt-4">
            <p className="text-xs text-muted">
              ...
              <span className="text-accent">Spotify Developer Dashboard</span>, ajoutez l'URI de
            ...
            <div className="flex gap-2">
              <input
                ...
                className="flex-1 rounded-lg border border-base-700 bg-base-800 px-3 py-2 text-sm text-fg outline-none focus:border-signal-500"
              />
              <button
      ...
      <section className="mt-4 rounded-xl2 border border-line bg-base-900 p-6">
        <div className="flex items-center justify-between">
          <div>
            <h2 className="font-medium text-fg">Lecture système (Windows)</h2>
            <p className="mt-0.5 text-sm text-muted">
            ...
            <div className="space-y-1.5">
              <div className="flex items-center justify-between">
                ...
                <button
                  ...
                  className="text-xs text-accent hover:text-signal-300 disabled:opacity-40"
                >
              ...
              <select
                ...
                className="w-full rounded-lg border border-base-700 bg-base-800 px-3 py-2 text-sm text-fg outline-none focus:border-signal-500"
              >
      ...
      <section className="mt-4 rounded-xl2 border border-line bg-base-900 p-6">
        <div className="flex items-center justify-between">
          <div>
            <h2 className="font-medium text-fg">Demo Mode</h2>
            <p className="mt-0.5 text-sm text-muted">
